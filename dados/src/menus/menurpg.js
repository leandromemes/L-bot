...
export default async function menurpg(prefix, botName = "MeuBot", userName = "Usuário") {
    ...
    const profileMenuTitle = "👤 PERFIL & STATUS";
    const economyMenuTitle = "💰 ECONOMIA & FINANÇAS";
    const activitiesMenuTitle = "🎯 ATIVIDADES DIÁRIAS";
    const adventureMenuTitle = "🗺️ AVENTURA & EXPLORAÇÃO";
    const combatMenuTitle = "⚔️ COMBATE & BATALHAS";
    const craftingMenuTitle = "🔨 CRAFTING & EQUIPAMENTOS";
    const socialMenuTitle = "💝 SOCIAL & INTERAÇÕES";
    const familyMenuTitle = "👨‍👩‍👧‍👦 FAMÍLIA & ADOÇÃO";
    const guildMenuTitle = "🏰 CLÃ & COMUNIDADE";
    const questMenuTitle = "📜 MISSÕES & CONQUISTAS";
    const petsMenuTitle = "🐾 PETS & COMPANHEIROS";
    const reputationMenuTitle = "⭐ REPUTAÇÃO & FAMA";
    const investmentMenuTitle = "📈 INVESTIMENTOS & BOLSA";
    const gamblingMenuTitle = "🎰 CASSINO & APOSTAS";
    const evolutionMenuTitle = "🌟 EVOLUÇÃO & PRESTIGE";
    const eventsMenuTitle = "🎉 EVENTOS";
    const premiumMenuTitle = "💎 LOJA PREMIUM";
    const adminMenuTitle = "🔧 ADMIN RPG (DONO)";

    // Header com o Rei 🤴 e a borda de Flor ❁
    const header = `╭┈⊰ 🤴 『 *${botName} RPG* 』\n${middleBorder}Olá, ${userName}!\n╰─┈┈┈┈┈◜❁◞┈┈┈┈┈─╯`;
