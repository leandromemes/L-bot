...
export default async function menuadm(prefix, botName = "MeuBot", userName = "Usuário") {
    // Definimos as variáveis fixas para travar o visual
    const menuTopBorder = "╭┈";
    const bottomBorder = "╰─┈┈┈┈┈◜❁◞┈┈┈┈┈─╯";
...
${menuTopBorder}${separatorIcon} *🛡️ GESTÃO DE USUÁRIOS*
${middleBorder}
...
${menuTopBorder}${separatorIcon} *💬 GESTÃO DO GRUPO*
${middleBorder}
...
${menuTopBorder}${separatorIcon} *👥 MODERADORES*
${middleBorder}
...
${menuTopBorder}${separatorIcon} *🤝 PARCERIAS*
${middleBorder}
...
${menuTopBorder}${separatorIcon} *🎨 CONFIGURAÇÕES*
${middleBorder}
