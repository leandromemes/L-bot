...
export default async function menubn(prefix, botName = "MeuBot", userName = "Usuário", isLiteMode = false) {
    ...
    const gamesMenuTitle = "🎮 JOGOS & DIVERSÃO 🎲";
    const phrasesMenuTitle = "💬 FRASES & TEXTOS 📜";
    const interactionsMenuTitle = "💬 INTERAÇÕES SOCIAIS 🤝";
    const relationshipMenuTitle = "💞 RELACIONAMENTOS ❤️";
    const hotInteractionsMenuTitle = '🔥 INTERAÇÕES "PICANTES" 😏';
    const maleFunMenuTitle = "🎯 BRINCADEIRAS MASCULINAS 🔥";
    const femaleFunMenuTitle = "💅 BRINCADEIRAS FEMININAS 👸";
    const maleRanksMenuTitle = "🏆 RANKINGS MASCULINOS 👑";
    const femaleRanksMenuTitle = "👸 RANKINGS FEMININOS 💎";
...
${middleBorder}${menuItemIcon}${prefix}brincalhao${isLiteMode ? '' : `\n${middleBorder}${menuItemIcon}${prefix}bolsonarista\n${middleBorder}${menuItemIcon}${prefix}petista\n${middleBorder}${menuItemIcon}${prefix}comunista\n${middleBorder}${menuItemIcon}${prefix}lulista\n${middleBorder}${menuItemIcon}${prefix}traidor\n${middleBorder}${menuItemIcon}${prefix}bandido\n${middleBorder}${menuItemIcon}${prefix}cachorro\n${middleBorder}${menuItemIcon}${prefix}vagabundo\n${middleBorder}${menuItemIcon}${prefix}pilantra`}
...
${middleBorder}${menuItemIcon}${prefix}brincalhona${isLiteMode ? '' : `\n${middleBorder}${menuItemIcon}${prefix}bolsonarista\n${middleBorder}${menuItemIcon}${prefix}petista\n${middleBorder}${menuItemIcon}${prefix}comunista\n${middleBorder}${menuItemIcon}${prefix}lulista\n${middleBorder}${menuItemIcon}${prefix}traidora\n${middleBorder}${menuItemIcon}${prefix}bandida\n${middleBorder}${menuItemIcon}${prefix}cachorra\n${middleBorder}${menuItemIcon}${prefix}vagabunda\n${middleBorder}${menuItemIcon}${prefix}pilantra`}
${middleBorder}${menuItemIcon}${prefix}mito
${middleBorder}${menuItemIcon}${prefix}padrao
${middleBorder}${menuItemIcon}${prefix}comedia${isLiteMode ? '' : `\n${middleBorder}${menuItemIcon}${prefix}psicopata`}
